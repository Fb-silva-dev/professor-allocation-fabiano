...
public class DepartmentController {
	...
	public ResponseEntity<Department> create(@RequestBody Department dept) {
		...
		// curl -v --request POST --header "Content-Type: application/json" --header
		// "Accept: application/json" --data-raw "{\"name\": \"Departamento de
		// Gastronomia\"}" "http://localhost:8080/departments"
	}
	...
	public ResponseEntity<Department> update(@PathVariable(name = "dept_id") Long id, @RequestBody Department dept) {
		...
		// curl -v --request PUT --header "Content-Type: application/json" --header
		// "Accept: application/json" --data-raw "{\"name\": \"departamento
		// gastronomico\"}" "http://localhost:8080/departments/3"
	}
	...
	//curl -v --request DELETE "http://localhost:8080/departments/1"
}
